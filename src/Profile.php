...
class Profile extends CommonGLPI
{
    ...
    {
        return __('GLPI Major', 'glpimajor');
    }
    ...
    private static function rights(): array
    {
        return [
            [
                'itemtype' => Page::class,
                'label'    => __('Status pages and maintenance windows', 'glpimajor'),
                'field'    => 'plugin_glpimajor_config',
            ],
            [
                'itemtype' => Incident::class,
                'label'    => __('Major incidents', 'glpimajor'),
                'field'    => 'plugin_glpimajor_declare',
            ],
        ];
    }
